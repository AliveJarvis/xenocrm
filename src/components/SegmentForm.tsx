...
//   const generateMessagesFromObjective = async () => {
//     if (!name.trim()) {
//       toast.error('Please enter or generate a campaign objective to generate messages and images');
//       return;
//     }
...
//       await toast.promise(
//         (async () => {
//           // Generate messages and images in parallel
//           const [generatedMessages, generatedImages] = await Promise.all([
//             generateObjectiveMessages(name),
//             generateCampaignImages(name)
//           ]);
...
//           } else {
//             toast.warning('No images generated. Try a different objective.');
//           }

//           return { generatedMessages, generatedImages };
//         })(),
//         {
//           loading: 'Generating message and image suggestions...',
//           success: 'Message and image suggestions generated successfully',
//           error: (err: unknown) => {
//             const error = err as Error;
//             return error.message === 'No messages generated' 
//               ? 'No messages generated. Try a different objective.' 
//               : 'Failed to generate message or image suggestions';
//           }
//         }
//       );
//     } catch (error) {
...
//             method: 'POST',
//             headers: { 'Content-Type': 'application/json' },
//             body: JSON.stringify({ name, rules, audienceSize, message: selectedMessage, image: selectedImage }),
//           });
...
//           </div>
//           <div>
//             <Label>Message and Image Suggestions</Label>
//             <div className="space-y-4">
//               <div className="flex space-x-2">
//                 <Button type="button" onClick={generateMessagesFromRules}>
//                   Generate from Rules
...
//                       <div
//                         key={index}
//                         className={`cursor-pointer border-2 ${selectedImage === img ? 'border-blue-500' : 'border-gray-200'}`}
